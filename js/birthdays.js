...
function months(cmonth){
    var month = document.getElementById(cmonth);
    month.length = 0;
    month.options.add(new Option("--月份--","--月份--"))
    for (i = 1; i < 13; i++) {    	
...
function change_date(cyear,cmonth){
    // var birthday = document.birthday;
    var year  = document.getElementById(cyear);
    var month = document.getElementById(cmonth);
    var day   = document.getElementById("date6");
